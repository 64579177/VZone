            ...
            __block NSInteger index = 0;
                [assets enumerateObjectsUsingBlock:^(PHAsset  *_Nonnull asset, NSUInteger idx, BOOL * _Nonnull stop) {
                    ...
                    [[TZImageManager manager]getOriginalPhotoDataWithAsset:asset completion:^(NSData *data, NSDictionary *info, BOOL isDegraded) {
                        ...
                        photoModel.fileName = [[VZAccountTool account].userName stringByAppendingString:[NSString stringWithFormat:@"%u%@",arc4random_uniform(99999)*arc4random_uniform(99999),name]];
        ...
        if (isSelectOriginalPhoto) {
            ...
            [assets enumerateObjectsUsingBlock:^(PHAsset  *_Nonnull asset, NSUInteger idx, BOOL * _Nonnull stop) {
              ...
              [[TZImageManager manager]getOriginalPhotoWithAsset:asset completion:^(UIImage *photo, NSDictionary *info) {
                  ...
                  [[TZImageManager manager]getOriginalPhotoDataWithAsset:asset completion:^(NSData *data, NSDictionary *info, BOOL isDegraded) {
                      ...
                      NSString *name = [[info[@"PHImageFileSandboxExtensionTokenKey"]componentsSeparatedByString:@"/"]lastObject];
                      photoModel.fileName = [[VZAccountTool account].userName stringByAppendingString:[NSString stringWithFormat:@"%u%@",arc4random_uniform(999999)*arc4random_uniform(999999),name]];
                      photoModel.orignalData = data;
            ...
            [assets enumerateObjectsUsingBlock:^(PHAsset  *_Nonnull asset, NSUInteger idx, BOOL * _Nonnull stop) {
                ...
                [[PHImageManager defaultManager]requestImageDataForAsset:asset options:option resultHandler:^(NSData * _Nullable imageData, NSString * _Nullable dataUTI, UIImageOrientation orientation, NSDictionary * _Nullable info) {
                    ...
                    NSString *name = [[info[@"PHImageFileSandboxExtensionTokenKey"]componentsSeparatedByString:@"/"]lastObject];
                    photoModel.fileName = [[VZAccountTool account].userName stringByAppendingString:[NSString stringWithFormat:@"%u%@",arc4random_uniform(997659)*arc4random_uniform(9342499),name]];
...
+ (void)getVideoPathFromPHAsset:(PHAsset *)asset cachePath:(NSString *)basePath Complete:(JYVideoPathCallback)videPathCallback  coverBackRightNow:(JYVideoCoverImageBackRightNow)coverCallbackNow cover:(UIImage *)cover {
    ...
    if (resource.originalFilename) {
        fileName = [[VZAccountTool account].userName stringByAppendingString:[NSString stringWithFormat:@"%u%@",arc4random_uniform(99999)*arc4random_uniform(99999),resource.originalFilename]];
    }
    //立刻回调视频封面图 ,名称 , 视频长短
    if (coverCallbackNow) {
